...
// TODO: Do zrobienia dodawanie piłkarza do bazy bo aktualnie to jakies dymy się dzieją
  ...
  $stm = $DB_con->prepare("INSERT INTO pilkarz VALUES(NULL, :imie, :nazwisko, :id_aktualny_klub, :data_urodzenia, :narodowosc, :wiek, :pozycja_boisko, :wartosc_rynkowa, :zdjecie)");
...
if(isset($_POST['transfer_wyslano'])){
  $id_zawodnik = $_POST['zawodnik'];
  $nowy_klub = $_POST['nowy_klub'];
  $typ = $_POST['typ'];
  $kwota = $_POST['kwota'];

  if($id_zawodnik == "" || $nowy_klub == "" || $kwota == ""){
...
try {
  ...
  $stm = $DB_con->prepare("INSERT INTO transfer VALUES(NULL, :id_pilkarz, :id_klub, :id_nowy_klub, :typ, :kwota)");
...
if($stm){
  $success[] = "Pomyślnie dodano transfer do bazy danych! <a href='index.php'>Przejdź aby zobaczyć</a>";
}else{
...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link disabled" data-toggle="tab" href="#news" role="tab" aria-controls="news" aria-expanded="true">News'a</a>
      </li>
      <li class="nav-item">
      ...
      <div class="col-md-9" style="margin-left:auto;margin-right:auto;">
        ...
        <form method="post">
          ...
          <div class="form-group zawodnik-box">
            ...
            <input type="text" class="form-control" placeholder="wpisz imie lub nazwisko" name="zawodnik">
          ...
          <div class="col-md-6">
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" placeholder="..." name="wiek">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
           ...
           <small class="form-text text-muted">Wartość podajemy w zł.</small>
         </div>
        </div>
   ...
   $(document).ready(function() {
     ...
     $(document).on("click", ".result p", function(){
      ...
      $(document).on("click", ".wynikSzukania p", function(){
        var val = $(".wynikSzukania p span").text();
        console.log(val);
          $(this).parents(".zawodnik-box").find('input[type="text"]').val(val);
